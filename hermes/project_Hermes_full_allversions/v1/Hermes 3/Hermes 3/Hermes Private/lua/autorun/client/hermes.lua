...
Hermes.log			= ( file.Exists( "hermes_lists_log.txt" ) && KeyValuesToTable( file.Read( "hermes_lists_log.txt" ) ) || {} )
...
Hermes.convars = {
	{ Item = "Aimbot", Setting = {
			{ Tab = "Aimbot", Items = {
					{ ConVar = "aimtype", Value = 2, Contents = { "Default", "Bone", "GetPos", "OBBCenter" }, Desc = "Aimtype:", Type = "multichoice", None = false },
...
Hermes.files = { "hermes.lua", "hermes_lists_friends.txt", "hermes_lists_entities.txt", "hermes_lists_binds.txt", "hermes_log.txt", "inject.lua", "gmcl_sys.dll", "gmcl_cmd.dll", "hake.dll", "hermes_cvar.dll", "hermes" }
...
function Hermes.Binds( binds )
	...
	function button:DoClick()
		if ( key == "" || func:GetValue() == "" ) then MsgN( "Failed" ) return end
...
function Hermes.VGUIMenu()
	...
	local binds = vgui.Create( "DPanel", propertysheet )
	...
	propertysheet:AddSheet( "Binds", binds, "gui/silkicons/bomb", false, false, nil )
end
