...
THIS CONTAINS REALLY OLD SCRIPTS WHEN I SUCKED LUA
--]]-----------------------------------------------------------------------------
...
--[[
	Nospread
	Desc: I better become a better coder. (remove for the public)
--]]

function PredictSpread( cmd, angle )
	return angle
end
