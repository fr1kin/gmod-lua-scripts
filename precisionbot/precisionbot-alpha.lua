...
function DrawENTESP()
	...
	local getcolors = Color( GetConVarNumber( "f_entitycol_r" ), GetConVarNumber( "f_entitycol_g" ), GetConVarNumber( "f_entitycol_b" ), GetConVarNumber( "f_entitycol_a" ) )
							...
							local Warningfix   = string.Replace(Warningfix, "npc_", "")
							local Warningfix   = string.Replace(Warningfix, "_", " ")
							local WeaponFix    = string.Replace(WeaponFix, "weapon_", "")
							local WeaponFix    = string.Replace(WeaponFix, "prop_vehicle_", "")
							local EntityFix    = string.Replace(EntityFix, "spawned_", "")
							local EntityFix    = string.Replace(EntityFix, "shipment_", "Shipment ")
							local EntityFix    = string.Replace(EntityFix, "dropped_", "")
							local EntityFix    = string.Replace(EntityFix, "dropped_", "")
							local EntityFix    = string.Replace(EntityFix, "smg_", "SMG ")
							local EntityFix    = string.Replace(EntityFix, "money_", "Money ")
							local EntityFixer  = string.upper( EntityFix )
							local WeaponFixer  = string.upper( WeaponFix )
							local Warningfixer = string.upper( Warningfix )
...
function DrawNPCESP()
	...
	local class = ent:GetClass()
			local getcolors = Color( GetConVarNumber( "f_npc_r" ), GetConVarNumber( "f_npc_g" ), GetConVarNumber( "f_npc_b" ), GetConVarNumber( "f_npc_a" ) )
							...
							// NPC NAME REMOVELS
							local Name = class
							local Name = string.Replace(Name, "npc_", "")
							local Name = string.Replace(Name, "turret_floor", " ")
							local PName = string.upper( Name )
